...
DESCRIPTION="Library for file value data types"
...
# Hard link libfvalue-9999.ebuild to libfvalue-YYYYMMDD.ebuild for releases
if [[ ${PV} == 9999 ]]; then
	KEYWORDS=""
else
	EGIT_COMMIT="${PV}"
...
DEPEND="
	...
	dev-libs/libfdatetime[static-libs?]
	dev-libs/libfguid[static-libs?]
	dev-libs/libfwnt[static-libs?]
"
RDEPEND="
	!static-libs? ( ${DEPEND} )
"
