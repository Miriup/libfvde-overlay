...
DESCRIPTION="Library for AES encryption"
...
# Hard link libcaes-9999.ebuild to libcaes-YYYYMMDD.ebuild for releases
if [[ ${PV} == 9999 ]]; then
	KEYWORDS=""
else
	EGIT_COMMIT="${PV}"
...
PATCHES=(
	"${FILESDIR}/0001-Remove-embedded-dependencies-and-Python-bindings-for.patch"
)
